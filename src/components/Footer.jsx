      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <a 
              href="mailto:anusharaj1804@gmail.com" 
            ...
            <a 
              href="https://www.linkedin.com/in/anusha18288" 
              target="_blank"
            ...
            <a 
              href="https://github.com/anusha342/" 
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-6 pt-6 text-center">
          ...
          <p className="text-pink-400 font-medium text-sm">
            Created with ❤️ by Anusha
          </p>
          <div className="flex justify-center gap-6 mt-4 text-sm text-gray-400">
            <Link to="#" className="hover:text-white transition-colors">Privacy Policy</Link>
            <Link to="#" className="hover:text-white transition-colors">Terms of Service</Link>
            <Link to="/contact" className="hover:text-white transition-colors text-cyan-400 font-medium">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
